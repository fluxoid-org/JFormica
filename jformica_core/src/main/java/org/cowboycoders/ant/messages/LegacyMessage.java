...
public class LegacyMessage extends Message 
  implements ExtendedInformationQueryable, DeviceInfoQueryable, DeviceInfoSettable {
  ...
  /*
  public LegacyMessage(Byte id, ArrayList<Byte> payload) {
    super(id, payload);
  }

  public LegacyMessage(MessageId id, ArrayList<Byte> payload) {
    super(id, payload);
  }*/
  ...
  /*
  public LegacyMessage(Message message) {
    super(message);
  }
  */
 ...
 public void decode(byte[] buffer, boolean noChecks) throws MessageException {
  ...
  /**
   * validates a value which has been requested to be set is within sensible limits
  ...
  /**
   * Helper method to set extended data info for a given {@code DataElements} member
  ...
  /* (non-Javadoc)
   * @see org.cowboycoders.ant.messages.DeviceInfoSettable#setDeviceNumber(int)
   */
  @Override
